...
st.write("Hello everyone! Your donation would greatly help improve this program and keep me fueled with coffee while working on it.")

import streamlit as st

donate_link = "https://www.paypal.me/h0licede"

st.write("Please consider donating to support my work: ")
st.markdown(f"[{donate_link}]({donate_link})")
